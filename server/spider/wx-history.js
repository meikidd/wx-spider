...
exports.start = function *(url, frommsgid, cookies) {
  ...
  // frommsgid = 203979588;
  cookies = 'wap_sid=CM+14YkBEkBKZ1QwTGxfRWFzNmVWdVd2eDk5dHNKSlpDMGNYMGM4dmJBU1NGb2NzU2pqbmp2bU9yMGxaVXhRMjNSOVlvUTNiGAQg/REoqPnDxAswpInEwwU=; wap_sid2=CM+14YkBElxsN1N6cE5qZWlNT1YwNWtuY1ZBVzdZN0E1XzZfdTRyXzUxN0hkSUxWSDRoZFh2QWM3Z2k2RklWcHo3UDg5SmZhb3B4eTNCa0tseUkzdlJUMHJMbC1QSFlEQUFBfg==; pgv_pvi=9680819200; RK=GH2Kjcd/U1; pt2gguin=o0466392519; ptcz=29d5119f080aa77b4b684c058f635456430c0baf7d0d37946842d7d5d057e759; pgv_pvid=65948818; sd_cookie_crttime=1482111254939; sd_userid=98581482111254939; tvfe_boss_uuid=f2e3801ed3167c1e';
  let historyArticles = [];
    ...
    while(waitForLastPage) {
      ...
      if (response.status !== 200) {
        ...
        if(data.ret !== 0) {
          ...
          frommsgid = list[list.length - 1].msgid;
